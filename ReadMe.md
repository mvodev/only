...
## Клонирование
```
  git clone https://github.com/mvodev/only
```
## Установка
```
  npm i
...
## Сборка проекта в режиме разработки
  ...
  npm run start
  ```
### Результат можно посмотреть на http://localhost:3000/ в режиме разработки или в папке dist при сборке проекта в режиме production 
